...
export default function Firstpage() {
  return (
    ...
    <img className='object-center px-2 ' src="/blogimage.jpg" alt="image" style={{height:"30rem" , width: "90rem" }} />
     ...
     <div class="max-w-sm rounded overflow-hidden shadow-lg mx-5 my-5 p-3">
     ...
     <div class="flex items-center">
         <img class="w-10 h-10 rounded-full mr-4" src="/blogimage.jpg" alt="Avatar of Jonathan Reinink"/>
         <div class="text-sm">
